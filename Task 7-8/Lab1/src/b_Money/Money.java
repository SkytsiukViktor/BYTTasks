...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		return this.amount*this.currency.getRate()==other.amount*other.currency.getRate();
	}
	...
	public Money add(Money other) {
		int newamount = (int) (this.amount+other.amount*other.currency.getRate()/this.currency.getRate());
	...
	public Money sub(Money other) {
		return new Money((int) (this.amount-other.amount*other.currency.getRate()/this.currency.getRate()),this.currency);
	}
	...
	public int compareTo(Object other) {
		Money moneyother=(Money)other;
		if(moneyother.universalValue()-this.universalValue()==0) {
			return 0;
		}else if(moneyother.universalValue()-this.universalValue()>0) {
			return -1;
		}else return 1;
